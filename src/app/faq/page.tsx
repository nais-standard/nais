    ...
    a: (
      <>
        ...
        <p>
          ...
          work. See the{' '}
          <a href="/governance" className="text-blue-600 dark:text-blue-300 hover:underline">
            Governance page
          </a>{' '}
          for the full model.
        </p>
  ...
  return (
    <div className="border-b border-slate-200 dark:border-white/10 last:border-0">
      <button
        ...
        aria-expanded={open}
      >
        <span className="font-medium text-slate-900 dark:text-white text-[0.9375rem] leading-snug group-hover:text-blue-600 dark:group-hover:text-blue-300 transition-colors">
          {item.q}
        </span>
        <span className="flex-shrink-0 mt-0.5 text-slate-400 dark:text-slate-500 group-hover:text-blue-500 dark:group-hover:text-blue-300 transition-colors">
          <svg
            width="18"
            height="18"
            viewBox="0 0 18 18"
      ...
      >
        <div className="pb-5 text-sm text-slate-600 dark:text-slate-300 leading-relaxed space-y-3 max-w-3xl [&_a]:text-blue-600 dark:[&_a]:text-blue-300 [&_a]:hover:underline [&_code]:text-[0.8em] [&_code]:bg-slate-100 dark:[&_code]:bg-white/[0.06] [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:rounded [&_code]:border [&_code]:border-slate-200 dark:[&_code]:border-white/10">
          {item.a}
        </div>
      </div>
    </div>
  ...
  return (
    <div className="min-h-screen">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-14">
        ...
        {/* Didn't find answer */}
        <div className="mt-10 pt-8 border-t border-slate-200 dark:border-white/10 text-center">
          <h2 className="text-base font-semibold text-slate-700 dark:text-slate-200 mb-2">Didn&apos;t find your answer?</h2>
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            <a
              ...
              className="inline-flex items-center gap-1.5 px-4 py-2 bg-slate-900 dark:bg-white hover:bg-slate-800 dark:hover:bg-slate-100 text-white dark:text-slate-900 text-sm font-medium rounded-md transition-colors"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 px-4 py-2 border border-slate-200 dark:border-white/10 hover:bg-slate-50 dark:hover:bg-white/[0.04] text-slate-700 dark:text-slate-200 text-sm font-medium rounded-md transition-colors"
            >
              Open an Issue
            </a>
          </div>
