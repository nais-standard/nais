        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="font-mono font-medium text-white">NAIS</span>
            </div>
            ...
            <div className="mt-4 flex items-center gap-2">
              <span className="inline-flex items-center px-2 py-0.5 rounded-full text-[0.625rem] font-semibold uppercase tracking-wide bg-blue-500/15 text-blue-300 border border-blue-500/20">
                v1.0 Draft
              </span>
              <span className="inline-flex items-center px-2 py-0.5 rounded-full text-[0.625rem] font-semibold uppercase tracking-wide bg-emerald-500/15 text-emerald-300 border border-emerald-500/20">
                Open Standard
              </span>
            </div>
          </div>
