...
// The homepage has its own fixed light/dark composition, so dark mode does not
// apply there; every other page supports it.
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-14">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              href="/quickstart"
              className="hidden md:inline-flex items-center gap-1.5 px-3.5 py-1.5 text-sm font-medium rounded-lg bg-gradient-to-r from-blue-600 to-violet-600 text-white shadow-sm shadow-violet-600/25 hover:brightness-110 transition-all"
            >
              Get started
            </Link>
